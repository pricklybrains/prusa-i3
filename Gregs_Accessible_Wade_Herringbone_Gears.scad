...
distance_between_axles = 40.4555;
gear_h = 10;
gear_shaft_h = 10;
...
motor_mount_access_radius = 19.7;
		...
		difference()
		{
			...
			for(i = [0:10]) {
				rotate([0, 0, (36 * i)])
					...
					rotate([0, 90, 180])
						teardrop(4.8, gear_h * 2, 90);
			}

			// weight/plastic reduction and branding
/*			for (i = [0:7]) {
				rotate([0, 0, 45 * i])
				translate([gear2_shaft_outer_r + 3.3 + AT, 0, gear_h / 2])
					rotate([0, 90, 0])
					teardrop(3.3, gear_h * 2, 90);
			}*/
		}
